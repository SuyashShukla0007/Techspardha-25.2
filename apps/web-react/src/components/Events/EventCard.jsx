...
function EventCard({
  ...
  return (
    <div className="bg-[#181818] rounded-lg overflow-hidden transform transition duration-300 hover:scale-[1.03] border-t-2 border-transparent hover:border-orange-500 max-w-sm mx-auto">
      {/* Image */}
      ...
      <div className="p-5">
        {/* Title */}
        <h3 className="text-xl font-bold text-white hover:text-orange-500 mb-2 tracking-wider uppercase transition-colors duration-200">
          {name}
        </h3>
